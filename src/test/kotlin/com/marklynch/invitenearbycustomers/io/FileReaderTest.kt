...
import com.marklynch.invitenearbycustomers.defaultCustomersFileName
...
class FileReaderTest {
    ...
    @Test
    fun `Test readFile()`() {
        assertEquals("Reading file failed", expected, readFile("$TEST_RESOURCES_BASE_PATH$defaultCustomersFileName"))
    }
...
{"latitude": "52.833502", "user_id": 25, "name": "David Behan", "longitude": "-8.522361"}"""
